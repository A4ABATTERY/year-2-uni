...
public class MoveTest {
    ...
    public void testExecute() {
        ...
        // input arguments
        List<String> args =
                new ArrayList<String>(Arrays.asList("mv", "file", "test"));
        // initialize mv command
        Move mv = new Move();
        // execute mv command
        mv.execute(args);
    ...
    public void testValidate() {
        ...
        List<String> args = new ArrayList<String>(Arrays.asList("mv"));
        Move mv = new Move();
        assertEquals("JShell: mv: Too many, or too few arguments: mv ",
